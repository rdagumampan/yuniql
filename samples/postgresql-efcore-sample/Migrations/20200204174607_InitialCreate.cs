        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lastuserid = table.Column<string>(maxLength: 128, nullable: false),
                    artifact = table.Column<byte[]>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK___yuniqldbversion", x => x.id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix___yuniqldbversion",
                table: "__yuniqldbversion",
                column: "version",
                unique: true);
