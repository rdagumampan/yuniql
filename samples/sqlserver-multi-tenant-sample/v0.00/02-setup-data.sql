...
SET IDENTITY_INSERT ${TENANT_RESERVED_NAME}.regions ON;
...
SET IDENTITY_INSERT ${TENANT_RESERVED_NAME}.regions OFF;  
GO
...
SET IDENTITY_INSERT ${TENANT_RESERVED_NAME}.locations ON;
...
SET IDENTITY_INSERT ${TENANT_RESERVED_NAME}.locations OFF;
GO