...
{
    public class RedshiftBulkImportService : IBulkImportService
    {
        private string _connectionString;
        private readonly ITraceService _traceService;

        public RedshiftBulkImportService(ITraceService traceService)
        {
        ...
        )
        {
            ...
            stopwatch.Start();
            _traceService.Info($"RedshiftBulkImportService: Started copying data into destination table {schemaName}.{tableName}");
            ...
            _traceService.Info($"RedshiftBulkImportService: Finished copying data into destination table {schemaName}.{tableName} in {stopwatch.ElapsedMilliseconds} ms");
        }
