...
dotnet pack ./yuniql-plugins/mysql/src/Yuniql.MySql.csproj -p:packageversion=0.2.0 -c release -o nupkgs
...
dotnet nuget push ./nupkgs/Yuniql.MySql.0.2.0.nupkg -k APIKEY -s https://api.nuget.org/v3/index.json
