...
**yuniql** (yuu-nee-kel). Free and open source schema versioning and database migration engine made natively with .NET Core. Zero runtime dependencies, use plain SQL scripts, bulk import CSV, integrate CI/CD pipelines, runs on with Windows and Linux. Supports SqlServer, PostgreSql, MySql, and MariaDB.
