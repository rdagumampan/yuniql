...
namespace Yuniql.PlatformTests
{
    ...
    public class MigrationServiceTests : TestBase
    {
        ...
        [TestMethod]
        public void Test_Run_Environment_Aware_Scripts()
        {
            //arrange
            var localVersionService = new LocalVersionService(_traceService);
            localVersionService.Init(_testConfiguration.WorkspacePath);
            ...
            var init_dev = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_init"), "_dev")).FullName;
            var init_test = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_init"), "_test")).FullName;
            var init_prod = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_init"), "_prod")).FullName;
            ...
            var pre_dev = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_pre"), "_dev")).FullName;
            var pre_test = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_pre"), "_test")).FullName;
            var pre_prod = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_pre"), "_prod")).FullName;
            ...
            var v00_dev = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "v0.00"), "_dev")).FullName;
            var v00_test = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "v0.00"), "_test")).FullName;
            var v00_prod = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "v0.00"), "_prod")).FullName;
            ...
            var draft_dev = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_draft"), "_dev")).FullName;
            var draft_test = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_draft"), "_test")).FullName;
            var draft_prod = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_draft"), "_prod")).FullName;
            ...
            var post_dev = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_post"), "_dev")).FullName;
            var post_test = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_post"), "_test")).FullName;
            var post_prod = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_post"), "_prod")).FullName;
            ...
            var erase_dev = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_erase"), "_dev")).FullName;
            var erase_test = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_erase"), "_test")).FullName;
            var erase_prod = Directory.CreateDirectory(Path.Combine(Path.Combine(_testConfiguration.WorkspacePath, "_erase"), "_prod")).FullName;

            _testDataService.CreateScriptFile(Path.Combine(erase_dev, $"erase_dev.sql"), _testDataService.GetSqlForCreateDbObject($"erase_dev"));
            _testDataService.CreateScriptFile(Path.Combine(erase_test, $"erase_test.sql"), _testDataService.GetSqlForCreateDbObject($"erase_test"));
            _testDataService.CreateScriptFile(Path.Combine(erase_prod, $"erase_prod.sql"), _testDataService.GetSqlForCreateDbObject($"erase_prod"));
            ...
            _testDataService.CheckIfDbObjectExist(_testConfiguration.ConnectionString, "erase_dev").ShouldBeFalse();
            _testDataService.CheckIfDbObjectExist(_testConfiguration.ConnectionString, "erase_test").ShouldBeTrue();
            _testDataService.CheckIfDbObjectExist(_testConfiguration.ConnectionString, "erase_prod").ShouldBeFalse();
        }
