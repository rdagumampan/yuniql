...
export YUNIQL_TEST_PLATFORM="mariadb"
...
docker rm mariadb -f
docker run -dit --name mariadb -e "MYSQL_ROOT_PASSWORD=P@ssw0rd!" -p 3306:3306 mariadb:latest --default-authentication-plugin=mysql_native_password
