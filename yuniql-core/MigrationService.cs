...
namespace Yuniql.Core
{
    ...
    public class MigrationService : IMigrationService
    {
        ...
        /// <summary>
        /// Returns all migration versions applied in the target database formatted as JSON
        /// </summary>
        public string GetAllVersionsAsJson(string schemaName = null, string tableName = null)
        {
            return _configurationDataService.GetAllVersionsAsJson(schemaName, tableName);
        }

        /// <summary>
        /// Clear all existing versions
        /// </summary>
        public int ClearAllVersions(string schemaName = null, string tableName = null)
        {
            return _configurationDataService.ClearAllVersions(schemaName, tableName);
        }
